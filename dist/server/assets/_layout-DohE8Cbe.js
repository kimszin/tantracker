...
function RouteComponent() {
  return /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto py-10", children: [
    /* @__PURE__ */ jsx(Breadcrumb, { children: /* @__PURE__ */ jsxs(BreadcrumbList, { children: [
      ...
      /* @__PURE__ */ jsx(BreadcrumbItem, { children: /* @__PURE__ */ jsx(BreadcrumbLink, { asChild: true, children: /* @__PURE__ */ jsx(Link, { to: "/dashboard/transactions", children: "Transactions" }) }) }),
      /* @__PURE__ */ jsx(BreadcrumbSeparator, {}),
      /* @__PURE__ */ jsx(BreadcrumbItem, { children: /* @__PURE__ */ jsx(BreadcrumbPage, { children: "Edit Transaction" }) })
    ] }) }),
    /* @__PURE__ */ jsx(Outlet, {})
  ] });
}
